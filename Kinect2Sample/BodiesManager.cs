...
namespace Kinect2Sample
{
    public class BodiesManager
    {
        ...
        public BodiesManager(CoordinateMapper coordMapper, Canvas drawableCanvas, int bodyCount)
        {
            ...
            this.Global_Ids = new ulong[]{0,0,0,0,0,0 };
        ...
        /// <summary>
        /// Updates all elipses and lines representing joints and bones with the latest tracked bodies. 
        /// </summary>
        ...
        internal void UpdateBodiesAndEdges(Body[] bodies)
        {
            ...
            for (int bodyIndex = 0; bodyIndex < bodies.Length; bodyIndex++)
            {
                ...
                if (body.IsTracked)
                {
                    ...
                    Global_Ids[bodyIndex] = body.TrackingId;
                }
                else
                {
