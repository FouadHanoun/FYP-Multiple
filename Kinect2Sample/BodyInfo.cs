    ...
    public class BodyInfo
    {
        ...
        public BodyInfo(Color bodyColor, double jointThickness)
        {
            ...
            foreach (JointType jointType in Enum.GetValues(typeof(JointType)))
            {
                ...
                if ((jointType != JointType.SpineBase) || (jointType!= JointType.HipRight) || (jointType != JointType.HipLeft) || (jointType != JointType.KneeLeft) 
                    || (jointType != JointType.KneeRight) || (jointType != JointType.AnkleRight) || (jointType != JointType.AnkleLeft) || (jointType != JointType.FootRight) || (jointType != JointType.FootLeft))
                {
